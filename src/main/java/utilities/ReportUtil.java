...
public class ReportUtil {
	...
	public static void setupExtentReporter() {
		...
		spark = new ExtentSparkReporter(System.getProperty("user.dir") + File.separatorChar + "ExtentReport"
		...
		extentTest.log(status, t,
				MediaEntityBuilder
						.createScreenCaptureFromPath(
								"." + File.separatorChar + "screenshots" + File.separatorChar + fileName + ".png")
						.build());
	}
